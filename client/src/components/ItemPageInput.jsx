...
export default function ItemInput(props) {
    const { clickFunction, edited, startName, startValue } = props;
    ...
    return (
        <tr className="ItemPageInput">
            ...
            <td><div className="ItemPageInput__buttons"><PanelButton text={edited ? dictionary.confirm[ctxLang.language] : dictionary.add[ctxLang.language]} className={"fa-solid fs-5 fa-circle-".concat(edited ? "check" : "plus")} onClick={handleClick} /></div></td>
        </tr>
    )
}
